        ...
        <>
            <div className="slider">
                ...
                <div className="sliderTab">
                    ...
                    <span className={slider == -200 ? 'circle active' : 'circle'} onClick={() => {setSlider(-200)}}></span>
                    <span className={slider == -300 ? 'circle active' : 'circle'} onClick={() => {setSlider(-300)}}></span>
                    <span className={slider == -400 ? 'circle active' : 'circle'} onClick={() => {setSlider(-400)}}></span>
                </div>
            </div>
        </>
    )
